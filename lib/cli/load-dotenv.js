...
module.exports = (stage, relativeDotenvPath) => {
  const defaultEnvFilePath = path.join(process.cwd(), relativeDotenvPath, '.env');
  const stageEnvFilePath = path.join(process.cwd(), relativeDotenvPath, `.env.${stage}`);
